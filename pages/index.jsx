...
export default function Home() {
  ...
  const head = () => (
    <Head>
      ...
      <meta name="keywords" content="the ossan newbie adventurer manga, the ossan newbie adventurer manga, the ossan newbie adventurer manhwa, read the ossan newbie adventurer, the ossan newbie adventurer anime, the ossan newbie adventurer read, baca komik the ossan newbie adventurer, baca the ossan newbie adventurer, the ossan newbie adventurer online, sololeveling, the ossan newbie adventurer 1, the ossan newbie adventurer chapter 1, the ossan newbie adventurer webtoon, manga like the ossan newbie adventurer, the ossan newbie adventurer comic, the ossan newbie adventurer1, solo max leveling, the ossan newbie adventurer 147, the ossan newbie adventurer 169, the ossan newbie adventurer light novel, the ossan newbie adventurer manga online, the ossan newbie adventurer read online, the ossan newbie adventurer 149, manga the ossan newbie adventurer, the ossan newbie adventurer 165, the ossan newbie adventurer reddit, only i level up, leveling solo, read solo levelling, the ossan newbie adventurer 168, the ossan newbie adventurer 170,  leveling manhwa, the ossan newbie adventurer anime studio, solo max level newbie manhwa, sololeveling anime, the ossan newbie adventurer 180, solo max newbie, manhwa with leveling system, solo level max, the ossan newbie adventurer 178, the ossan newbie adventurer 179, the ossan newbie adventurer 176, the ossan newbie adventurer volume 5"></meta>
    </Head >
  );
